...
static uint16_t revision = BOARD_REV_UNKNOWN;
static bool gsg_production = false;
#else
static const uint16_t revision = (_BOARD_REVISION_MAJOR_ << 8) | _BOARD_REVISION_MINOR_;
#endif
...
void detect_hardware_revision(void)
{
    ...
    */
    ...
    struct {
        ...
        { BOARD_REV_0_6,         1 },
        { BOARD_REV_UNKNOWN,    22 },
        { BOARD_REV_1_3,        24 },
        { BOARD_REV_1_2,        26 },
        { BOARD_REV_1_0,        28 },
        { BOARD_REV_1_1,        31 },
        { BOARD_REV_UNKNOWN,    48 },
        { BOARD_REV_0_7,        51 },
    };
